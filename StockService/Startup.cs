...
using StockService.Handlers.CommandHandlers;
using StockService.Handlers.QueryHandlers;
using System;
...
namespace StockService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISaveStockCommandHandler, SaveStockCommandHandler>();
            services.AddScoped<IDateRangeStockQueryHandler, DateRangeStockQueryHandler>();
        }
